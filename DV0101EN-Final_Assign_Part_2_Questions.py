...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            value='Select Statistics',  # Updated default value
            placeholder='Select a Year',  # Updated placeholder
            style={'width': '80%', 'padding': '3px', 'font-size': '20px', 'text-align-last': 'center'}  # Updated style
        )
    ]),
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2 = dcc.Graph(
            figure=px.line(average_sales, x='Vehicle_Type', y='Automobile_Sales', title="Average Vehicles Sold by Vehicle Type during Recession Period")
        )       
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type', title="Expenditure Share by Vehicle Type during Recession Period")
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(unemployment_effect, x='unemployment_rate', y='Vehicle_Type', title="Effect of Unemployment Rate on Vehicle Type and Sales during Recession Period")
        )
...
# Plot 4: Pie chart for total advertisement expenditure for each vehicle type
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title='Total Advertisement Expenditure by Vehicle Type in {input_year}'))
